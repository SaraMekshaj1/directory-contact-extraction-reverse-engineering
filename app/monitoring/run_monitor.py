...
class RunMonitor:
    ...
    def finish(
        ...
        self._logger.info("Expected records    : %s", expected if expected is not None else "N/A")
        self._logger.info("Records scraped     : %d", scraped)
        ...
        self._logger.info("Records failed      : %d", self._statistics.items_failed)
